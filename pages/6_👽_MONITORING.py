...
with menu_monitoring_2:
    ...
    with menu_monitoring_2_2:
        ...
        try:
            ...
            df_SIKAPNonTender_OK_filter = con.execute(f"SELECT nama_satker, nama_paket, kd_nontender, mtd_pemilihan, AVG(indikator_penilaian) WHERE indikator_penilaian IS NOT NULL GROUP BY kd_nontender").df()
