...
with menu_monitoring_2:
    ...
    with menu_monitoring_2_2:
        ...
        try:
            ...
            df_SIKAPNonTender_OK_filter = con.execute("SELECT kd_nontender AS KODE_PAKET, nama_paket AS NAMA_PAKET, jenis_pengadaan AS JENIS_PENGADAAN, nama_ppk AS NAMA_PPK, nama_penyedia AS NAMA_PENYEDIA, AVG(total_skors) AS SKOR_PENILAIAN FROM df_SIKAPNonTender_OK GROUP BY KODE_PAKET, NAMA_PAKET, JENIS_PENGADAAN").df()
