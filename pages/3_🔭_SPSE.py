...
with menu_spse_4:
    ...
    jumlah_PesertaTender_menang = con.execute(f"SELECT * FROM df_PesertaTenderDetail_filter WHERE nilai_penawaran != 0 AND nilai_terkoreksi != 0 AND pemenang != 0").df()
    ...
    data_pt_3.metric(label="Jumlah Peserta Yang Menang", value="{:.}".format(jumlah_PesertaTender_nawar.shape[0]))
    style_metric_cards()
