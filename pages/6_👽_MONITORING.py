...
with menu_monitoring_2:
    ...
    with menu_monitoring_2_2:
        ...
        try:
            ...
            df_SIKAPNonTender_OK_1 = con.execute("SELECT nama_satker, nama_paket, nilai_indikator, total_skors FROM df_SIKAPNonTender_OK WHERE nama_paket IS NOT NULL GROUP BY nama_paket").df()
