...
with menu_spse_4:
    ...
    jumlah_PesertaTender_menang = con.execute(f"SELECT * FROM df_PesertaTenderDetail_filter WHERE nilai_penawaran != 0 AND nilai_terkoreksi != 0 AND pemenang != 0 AND pemenang IS NOT NULL").df()
